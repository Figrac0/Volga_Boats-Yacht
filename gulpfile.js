...
//     gulp.watch("./src/index.html", gulp.parallel("copy-html"));
//     gulp.watch("./src/policy.html", gulp.parallel("copy-policy"));
//     gulp.watch("./src/icons/**/*.*", gulp.parallel("copy-assets"));
//     gulp.watch("./src/img/**/*.*", gulp.parallel("copy-assets"));
//     gulp.watch("./src/scss/**/*.scss", gulp.parallel("build-sass"));
//     gulp.watch("./src/js/**/*.js", gulp.parallel("build-js"));
...
// gulp.task(
//     "build",
//     gulp.parallel("copy-html", "copy-policy", "copy-assets", "build-sass", "build-js")
// );

// gulp.task("prod", () => {
//     gulp.src("./src/index.html").pipe(gulp.dest(dist));
//     gulp.src("./src/policy.html").pipe(gulp.dest(dist));
//     gulp.src("./src/img/**/*.*").pipe(gulp.dest(dist + "/img"));
//     gulp.src("./src/icons/**/*.*").pipe(gulp.dest(dist + "/icons"));
